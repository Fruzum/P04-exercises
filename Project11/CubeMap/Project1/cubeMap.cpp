...
void CCubeMap::Render(glm::mat4& _CameraProjection, glm::mat4& _CameraView)
{
	...
	glm::mat4 model = glm::scale(glm::mat4(), glm::vec3(1000.0f, 100.0f, 100.0f));

	glm::mat4 MVP = _CameraProjection * _CameraView * model;
