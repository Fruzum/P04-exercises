...
void render(void)
{
	...
	glm::mat4 rotate = glm::rotate(glm::mat4(), glm::radians(90.0f), rotateAxis);

	GLuint rotationLoc = glGetUniformLocation(program, "rotate");
	glUniformMatrix4fv(
		rotationLoc,				//transformation location
		1,							//How many Matrix
		GL_FALSE,					//Normalizes
		glm::value_ptr(rotate));	//Point to memory
