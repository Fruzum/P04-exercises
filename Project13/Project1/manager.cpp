...
void CManager::Initialise()
{
	...
	/* Create the program */
	m_Program = shader.CreateProgram("VertexReflect.txt", "FragmentReflection.txt");
	m_Program2 = shader.CreateProgram("cubeMapVertex.txt", "cubeMapFragment.txt");
	m_Program3 = shader.CreateProgram("VertexModel.txt", "FragmentModel.txt");
	...
	my3DModel = new Model("Models/pug/Dog 1.obj", m_Program3);
...
void CManager::Render()
{
	...
	glUniform1i(glGetUniformLocation(m_Program, "skybox"), 3);
	...
	glm::mat4 rotateX = glm::rotate(glm::mat4(), glm::radians(0.0f), rotationAxisX);
	// RotateY
	glm::vec3 rotationAxisY = glm::vec3(0.0f, 1.0f, 0.0f);
	glm::mat4 rotateY = glm::rotate(glm::mat4(), glm::radians(0.0f), rotationAxisY);
	// RotateZ
	glm::vec3 rotationAxisZ = glm::vec3(0.0f, 0.0f, 1.0f);
	glm::mat4 rotateZ = glm::rotate(glm::mat4(), glm::radians(0.0f), rotationAxisZ);

	glm::mat4 rotate = rotateZ * rotateY * rotateX;

	glm::mat4 model = translate * rotate * scale;
	modelLoc = glGetUniformLocation(m_Program3, "model");
	glUniformMatrix4fv(
